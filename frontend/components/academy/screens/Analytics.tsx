  ...
  return (
    <div data-screen-label="Analytics" style={{ maxWidth: 1180, margin: "0 auto" }}>
      <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 22, marginBottom: 22 }} className="acad-analytics-top">
        {/* Charge earned */}
        <section className="acad-card" style={{ ...card, padding: 24 }}>
          ...
          <div className="acad-chart" style={{ display: "flex", alignItems: "flex-end", gap: 14, height: 190, paddingTop: 10 }}>
            {history.map((d) => (
        ...
        {/* Unaided-solve gauge */}
        <section className="acad-card" style={{ ...card, padding: 24, display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <div className="acad-gauge" style={{ position: "relative", width: 190, height: 190, borderRadius: "50%", background: gaugeBackground(unaided), border: "4px solid #2E2620", display: "flex", alignItems: "center", justifyContent: "center", margin: "6px 0" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {coverage.map((c) => (
            <div key={c.zone_slug} style={{ display: "flex", alignItems: "center", gap: 18 }} className="acad-coverage-row">
              <div className="acad-cov-label" style={{ width: 150, flex: "none", fontFamily: FREDOKA, fontWeight: 600, fontSize: 14 }}>{c.pattern}</div>
